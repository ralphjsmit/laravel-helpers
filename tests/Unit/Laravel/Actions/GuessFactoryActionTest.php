...
it('can guess the name of a factory', function (string $input, string $expectedGuess, bool $guessFactoryNamesWithDomainNamespace = null, bool $guessFactoryNamesWithSupportNamespace = null) {
    ...
    ['App\\X\\X\\User', ''],
    ['User', ''],
    ['RalphJSmit\\Filament\\CMS\\Blog\\Models\\Page', 'Database\\Factories\\RalphJSmit\\Filament\\CMS\\Blog\\PageFactory', false, true],
